...
sudo cp -f $GITHUB_WORKSPACE/diy/patches/002-fix-adding-offloading-device.patch package/network/config/firewall4/patches/002-fix-adding-offloading-device.patch
sudo cp -f $GITHUB_WORKSPACE/diy/patches/10_system.js /feeds/luci/modules/luci-mod-status/htdocs/luci-static/resources/view/status/include/10_system.js
