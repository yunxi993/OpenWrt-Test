...
mkdir -p /openwrt/package/firmware/i915
curl -L https://git.kernel.org/pub/scm/linux/kernel/git/firmware/linux-firmware.git/plain/i915/glk_dmc_ver1_04.bin -o /openwrt/package/firmware/i915/glk_dmc_ver1_04.bin
...
echo 'CONFIG_EXTRA_FIRMWARE_DIR="/openwrt/package/firmware"' >> target/linux/x86/64/config-6.6
