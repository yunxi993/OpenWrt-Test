...
sed 's,LINUX_VERSION-6.6 = .54,LINUX_VERSION-6.6 = .52,g' include/kernel-6.6
sed 's,6.6.54 = 5fae86*,6.6.52 = 1591ab348399d4aa53121158525056a69c8cf0fe0e90935b0095e9a58e37b4b8,g' include/kernel-6.6
