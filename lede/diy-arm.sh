...
# re close bridge-nf
sed -i '754,755d 774d' package/openwrt-passwall2/luci-app-passwall2/root/usr/share/passwall2/app.sh
#sed -i '774d' package/openwrt-passwall2/luci-app-passwall2/root/usr/share/passwall2/app.sh
