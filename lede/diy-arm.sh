...
# re close bridge-nf
sed -i '754,755d' package/openwrt-passwall2/luci-app-passwall2/root/usr/share/passwall2/app.sh
sed -i '776d' package/openwrt-passwall2/luci-app-passwall2/root/usr/share/passwall2/app.sh
