...
sed -i '741 a <tr><td width="33%"><%:Compiler author%></td><td>https://t.me/passwall2</td></tr>' package/lean/autocore/files/arm/index.htm
sed -i '742 a <tr><td width="33%"><%:Compiler author%></td><td>https://t.me/passwall2</td></tr>' package/lean/autocore/files/x86/index.htm

sed -i '4123 a msgid "Compiler author"' feeds/luci/modules/luci-base/po/zh-cn/base.po
sed -i '4124 a msgstr "交流群"' feeds/luci/modules/luci-base/po/zh-cn/base.po
